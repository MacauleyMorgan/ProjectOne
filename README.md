...
### Steps to test
Navigate to the website using the browser (Google Chrome/Firefox) [Index.html](index.html) 
Open the developer section and resize to 250px wide
Set the zoom factor in the window to its most zoomed out setting 50%
Resize the width to the maximum width
### Expected
