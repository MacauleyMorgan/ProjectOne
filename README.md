...
### Color Scheme
The color scheme of the website is primarily green with grey and white aspects throughout. The hex codes used provide a 5.08 contrast when evaluated with the Wave accessibility tool when comparing the green and grey. A further comparison between grey and white shows a contrast of 8.97 and green and white, a value of 1.77, however these colors are not used to display text. 
...
# Testing
## Responsiveness
All pages are tested to support upwards of 256px resolution to allow for very small screen sizes to view the site such as the Samsung Galaxy Fold.
### Steps to test
